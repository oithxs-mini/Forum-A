                ...
                <?php foreach ($message_array as $value) { ?>
                    <article class="alert-secondary">
                        <div class="info">
                            ...
                            <!-- 直接書き込み（試験） -->
                            <a href="pushreport.php?message_id=<?php echo $value['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
